...
<body>
    ...
    <br><br><br>
      ...
      <li class="breadcrumb-item"><a href="eventosadmin.php">Eventos</a></li>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <!--Formulario-->
        <form onreset="borrar();" action="guardareventosadmin.php" method="POST" enctype="multipart/form-data">
...
<?php 
  ...
  <i class="fa fa-trash" aria-hidden="true"></i><a href="deleventosadmin.php?id=<?php echo $res['id']; ?>"> Eliminar Evento</a>
