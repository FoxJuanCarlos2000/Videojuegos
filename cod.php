...
<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
  ...
  <nav aria-label="breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item"><a href="./cod.php">Call of Duty</a></li>
    </ol>
  </nav>
  ...
  <div class="p-4 p-md-5 mb-4 text-white rounded bg-dark">
    <img src="./imagenes/codbn.jpg" width="1000px" height="300">
    <div class="col-md-6 px-0">
      <h1 class="display-4 fst-italic"> CALL OF DUTY</h1>
      <p class="lead my-3">Call of Duty: Mobile es un juego gratuito tipo shooter desarrollado por Activision para la plataforma de Android y iOS. Fue lanzado el 1 de octubre de 2019.</p>
    </div>
  </div>
 ...
 <?php 
  ...
  $query="SELECT * FROM `publicaciones` WHERE `categoria`='Call Of Duty'";
