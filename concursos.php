           ...
           <li class="nav-item">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                ...
                Miembros</a>
                <a class="dropdown-item" href="concursos.php"><i class="fa fa-gift" aria-hidden="true"></i>
                Concursos</a>
                <a class="dropdown-item" href="#"><i class="fa fa-calendar-o" aria-hidden="true"></i>
                Eventos</a>
                <a class="dropdown-item" href="#"><i class="fa fa-trophy" aria-hidden="true"></i>
                Torneos</a>
              </div>
            </li>
