...
<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
    ...
    <br><br><br>
        ...
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="./fortnite.php">Fortnite</a></li>
          </ol>
        </nav>
  ...
  <img src="./imagenes/fortnitebn.png" width="1000px" height="300">   
    <div class="col-md-6 px-0" >
    <h1 class="display-4 fst-italic">FORTNITE</h1>
      <p class="lead ">Fortnite es un videojuego del año 2017 desarrollado por la empresa Epic Games, lanzado como diferentes paquetes de software que presentan diferentes modos de juego, pero que comparten el mismo motor de juego y mecánicas. Fue anunciado en los Spike Video Game Awards en 2011.</p>
      </div>
 ...
 <?php 
  ...
  $query="SELECT * FROM `publicaciones` WHERE `categoria`='Fortnite'";
