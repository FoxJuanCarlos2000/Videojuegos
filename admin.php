...
<body>
    ...
    <br><br><br>
      ...
      <li class="breadcrumb-item"><a href="admin.php">Publicaciones</a></li>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <!--Formulario-->
        <form onreset="borrar();" action="guardarpostadmin.php" method="POST" enctype="multipart/form-data">
    ...
    <div class="input-group mb-3">
      <input type="datetime-local" class="form-control" placeholder="Ingresa fecha y hora de la publicación" aria-label="Recipient's username" aria-describedby="basic-addon2" name="fecha">
    ...
    <div class="input-group">
     ...
     <textarea class="form-control" aria-label="With textarea" placeholder="En una breve descripción del post &#128521;" name="desc_post"></textarea>
    </div>
...
<div class="container" >
 <i class="fa fa-trash" aria-hidden="true"></i><a href="delpostadmin.php?id=<?php echo $res['id']; ?>"> Eliminar Publicación</a>
