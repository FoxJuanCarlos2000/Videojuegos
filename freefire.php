...
<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
  ...
  <nav aria-label="breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item"><a href="./freefire.php">FreeFire</a></li>
    </ol>
  </nav>
  ...
  <div class="p-4 p-md-5 mb-4 text-white rounded bg-dark">
    <img src="./imagenes/ffbn.jpg" width="1000px" height="300">
    <div class="col-md-6 px-0">
      <h1 class="display-4 fst-italic">GARENA FREE FIRE</h1>
      <p class="lead my-3">Garena Free Fire es un juego de Battle Royal, desarrollado por 111 Dots Studio​ y publicado por Garena para Android e iOS.​​ Se convirtió en el juego móvil más descargado a nivel mundial en 2019.​ Debido a su popularidad, el juego recibió el premio al "Mejor Juego de Votación Popular" de Google Play Store en 2019.​</p>
    </div>
  </div>
 ...
 <?php 
  ...
  $query="SELECT * FROM `publicaciones` WHERE `categoria`='Free Fire'";
